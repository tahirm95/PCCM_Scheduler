...
try:
    ...
    # Notebook/Colab execution path where __file__ is not defined.
    _THIS_FILE = Path.cwd() / "max_penalty_calculator.py"

SCHEDULER_FILE = _THIS_FILE.with_name("fellowship_scheduler_2026_02_17.py")
